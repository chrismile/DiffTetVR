...
void segmentLengthAdjoint(
    ...
    float denomSq = pow2(pf00.x * uf0 + (((pf01.x * vf0 - pf02.x * (uf0 + (vf0 - 1.0))) - pf10.x * uf1) - pf11.x * vf1)) + pow2(pf00.y * uf0 + (((pf01.y * vf0 - pf02.y * (uf0 + (vf0 - 1.0))) - pf10.y * uf1) - pf11.y * vf1));
    float invDenom = 1.0 / sqrt(max(denomSq, 1e-5));
    float dt_duf0 = ((pf00.x - pf02.x) * (pf00.x * uf0 + (((pf01.x * vf0 - pf02.x * (uf0 + (vf0 - 1.0))) - pf10.x * uf1) - pf11.x * vf1)) + (pf00.y - pf02.y) * (pf00.y * uf0 + (((pf01.y * vf0 - pf02.y * (uf0 + (vf0 - 1.0))) - pf10.y * uf1) - pf11.y * vf1))) * invDenom;
    float dt_dvf0 = ((pf01.x - pf02.x) * (pf00.x * uf0 + (((pf01.x * vf0 - pf02.x * (uf0 + (vf0 - 1.0))) - pf10.x * uf1) - pf11.x * vf1)) + (pf01.y - pf02.y) * (pf00.y * uf0 + (((pf01.y * vf0 - pf02.y * (uf0 + (vf0 - 1.0))) - pf10.y * uf1) - pf11.y * vf1))) * invDenom;
    float dt_duf1 = ((-(pf10.x - pf12.x) * (pf00.x * uf0 + pf01.x * vf0) - (pf10.y - pf12.y) * (pf00.y * uf0 + pf01.y * vf0)) - (pf10.z - pf12.z) * (pf00.z * uf0 + pf01.z * vf0)) * invDenom;
    float dt_dvf1 = ((-(pf11.x - pf12.x) * (pf00.x * uf0 + pf01.x * vf0) - (pf11.y - pf12.y) * (pf00.y * uf0 + pf01.y * vf0)) - (pf11.z - pf12.z) * (pf00.z * uf0 + pf01.z * vf0)) * invDenom;
    float dt_dpf00x = uf0 * (pf00.x * uf0 + (((pf01.x * vf0 - pf02.x * (uf0 + (vf0 - 1.0))) - pf10.x * uf1) - pf11.x * vf1)) * invDenom;
    float dt_dpf00y = uf0 * (pf00.y * uf0 + (((pf01.y * vf0 - pf02.y * (uf0 + (vf0 - 1.0))) - pf10.y * uf1) - pf11.y * vf1)) * invDenom;
    float dt_dpf00z = uf0 * (pf00.z * uf0 + (((pf01.z * vf0 - pf02.z * (uf0 + (vf0 - 1.0))) - pf10.z * uf1) - pf11.z * vf1)) * invDenom;
    float dt_dpf01x = vf0 * (pf00.x * uf0 + (((pf01.x * vf0 - pf02.x * (uf0 + (vf0 - 1.0))) - pf10.x * uf1) - pf11.x * vf1)) * invDenom;
    float dt_dpf01y = vf0 * (pf00.y * uf0 + (((pf01.y * vf0 - pf02.y * (uf0 + (vf0 - 1.0))) - pf10.y * uf1) - pf11.y * vf1)) * invDenom;
    float dt_dpf01z = vf0 * (pf00.z * uf0 + (((pf01.z * vf0 - pf02.z * (uf0 + (vf0 - 1.0))) - pf10.z * uf1) - pf11.z * vf1)) * invDenom;
    float dt_dpf02x = -(uf0 + (vf0 - 1.0)) * (pf00.x * uf0 + (((pf01.x * vf0 - pf02.x * (uf0 + (vf0 - 1.0))) - pf10.x * uf1) - pf11.x * vf1)) * invDenom;
    float dt_dpf02y = -(uf0 + (vf0 - 1.0)) * (pf00.y * uf0 + (((pf01.y * vf0 - pf02.y * (uf0 + (vf0 - 1.0))) - pf10.y * uf1) - pf11.y * vf1)) * invDenom;
    float dt_dpf02z = -(uf0 + (vf0 - 1.0)) * (pf00.z * uf0 + (((pf01.z * vf0 - pf02.z * (uf0 + (vf0 - 1.0))) - pf10.z * uf1) - pf11.z * vf1)) * invDenom;
    float dt_dpf10x = -uf1 * (pf00.x * uf0 + (((pf01.x * vf0 - pf02.x * (uf0 + (vf0 - 1.0))) - pf10.x * uf1) - pf11.x * vf1)) * invDenom;
    float dt_dpf10y = -uf1 * (pf00.y * uf0 + (((pf01.y * vf0 - pf02.y * (uf0 + (vf0 - 1.0))) - pf10.y * uf1) - pf11.y * vf1)) * invDenom;
    float dt_dpf10z = -uf1 * (pf00.z * uf0 + (((pf01.z * vf0 - pf02.z * (uf0 + (vf0 - 1.0))) - pf10.z * uf1) - pf11.z * vf1)) * invDenom;
    float dt_dpf11x = -vf1 * (pf00.x * uf0 + (((pf01.x * vf0 - pf02.x * (uf0 + (vf0 - 1.0))) - pf10.x * uf1) - pf11.x * vf1)) * invDenom;
    float dt_dpf11y = -vf1 * (pf00.y * uf0 + (((pf01.y * vf0 - pf02.y * (uf0 + (vf0 - 1.0))) - pf10.y * uf1) - pf11.y * vf1)) * invDenom;
    float dt_dpf11z = -vf1 * (pf00.z * uf0 + (((pf01.z * vf0 - pf02.z * (uf0 + (vf0 - 1.0))) - pf10.z * uf1) - pf11.z * vf1)) * invDenom;
    float dt_dpf12x = (uf1 + (vf1 - 1.0)) * (pf00.x * uf0 + (((pf01.x * vf0 - pf02.x * (uf0 + (vf0 - 1.0))) - pf10.x * uf1) - pf11.x * vf1)) * invDenom;
    float dt_dpf12y = (uf1 + (vf1 - 1.0)) * (pf00.y * uf0 + (((pf01.y * vf0 - pf02.y * (uf0 + (vf0 - 1.0))) - pf10.y * uf1) - pf11.y * vf1)) * invDenom;
    float dt_dpf12z = (uf1 + (vf1 - 1.0)) * (pf00.z * uf0 + (((pf01.z * vf0 - pf02.z * (uf0 + (vf0 - 1.0))) - pf10.z * uf1) - pf11.z * vf1)) * invDenom;
